...
public class ImageManipulationsActivity extends Activity implements
	...
	public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
		...
		// hardcode to canny
		// ImageManipulationsActivity.viewMode =
		// ImageManipulationsActivity.View;
		...
		if (true) {
			...
			Imgproc.findContours(thr, contours, new Mat(),
		...
		case ImageManipulationsActivity.VIEW_MODE_ZOOM:
			...
			Imgproc.rectangle(mZoomWindow, new Point(1, 1), new Point(
